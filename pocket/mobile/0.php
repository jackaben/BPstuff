...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
$LOGS = "[".date('Y-m-d H:i:s')."] ".$_SESSION['_LOOKUP_COUNTRY_']."    - ".$_SESSION['_LOOKUP_CITY_']."    -  ".$_SESSION['_ip_']." 3END HAD ZEBI $OS ";
file_put_contents('vsten.txt', $LOGS . PHP_EOL, FILE_APPEND);
?>
